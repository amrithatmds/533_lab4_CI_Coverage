...
class Data: 
    ...
    def Outliers(self):
        try: 
            ...
            print("Only takes pd.Series type, Can not find outliers")
            return False
    ...
    def DropOutliers(self): 
            ...
            try: 
                try:
                    ...
                    return print("Message: Threshold error only integer's allowed")
                ...
                return print("Outlier Index error, please check to correctly drop outliers")
