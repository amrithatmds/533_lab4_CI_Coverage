import statswranger_Test.statswrangler.training as tr
import pandas as pd
import unittest
...
df0 = pd.read_csv("statswranger_Test/train.csv")
...
tr1 = pd.read_csv("statswranger_Test/train1.csv", index_col="Unnamed: 0")
tt1 = pd.read_csv("statswranger_Test/test1.csv", index_col="Unnamed: 0")

tr2 = pd.read_csv("statswranger_Test/train2.csv", index_col="Unnamed: 0")
tt2 = pd.read_csv("statswranger_Test/test2.csv", index_col="Unnamed: 0")

tr3 = pd.read_csv("statswranger_Test/train3.csv", index_col="Unnamed: 0")
tt3 = pd.read_csv("statswranger_Test/test3.csv", index_col="Unnamed: 0")
